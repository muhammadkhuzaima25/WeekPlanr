    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--bg-base)' }}>
      <div style={{ maxWidth: 400, width: '100%', padding: '0 24px' }}>
        <Link to="/" className="flex items-center justify-center gap-2.5 mb-8" style={{ textDecoration: 'none' }}>
          <div className="flex items-center justify-center rounded-lg" style={{ width: 36, height: 36, background: 'linear-gradient(135deg, #00C98A, #00C98A)', boxShadow: '0 0 12px #00C98A50' }}>
        ...
        <div className="w-full flex justify-center" style={{ transition: 'none' }}>
          <div style={{ width: '352px', minWidth: '352px', maxWidth: '352px', transition: 'none' }}>
            <GoogleLogin
